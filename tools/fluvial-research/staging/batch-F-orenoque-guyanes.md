# Batch F — Nouvelle-Andalousie / Suriname (delta de l'Orénoque → Guyanes)

Session de recherche sur 20 cours d'eau **déjà nommés** sur la carte Jaillot
(1708), secteur delta de l'Orénoque et côte des Guyanes (Suriname
historique : Essequibo, Berbice, Corentyne, Suriname, Marowijne/Commewijne).
Méthode reprise à l'identique de la session précédente (fleuves sans nom,
voir `fluvial-identification-synthese.md`) : nom, territoire, établissements
proches (`nearbySettlements`, recoupés avec `js/villes-data.js`), cours
voisins déjà identifiés, `[x,y]` en CRS Leaflet Simple (8500×5320 px,
**aucune valeur GPS réelle**), distances internes à la carte uniquement
utilisables pour la position relative.

Ancrages repris de la session précédente (secteur Nouvelle-Grenade/
Nouvelle-Andalousie) :
- **R028** (jonction Orénoque, près de Santo Tomé de Guayana) — révisé à
  **Río Usupamo**, confiance faible, en raison de l'anachronisme de
  Santo Tomé de Guayana (posée sur l'Usupamo de 1642 à 1764, pas sur le
  Caroní pendant la période 1713-1720).
- **R029** (près de San José de Macuro) — non déterminé.

## Constat général du secteur

Deux sous-ensembles nettement différents en termes de fiabilité :

1. **Grands fleuves des Guyanes** (Essequebe, Berbice, Corretine, Suriname,
   Amacuro, Poumaron, Waymy) : identification directe très fiable, les
   noms Jaillot sont des formes à peine déformées de toponymes hollandais/
   indigènes toujours en usage aujourd'hui, et l'ordre côtier ouest-est
   du dossier correspond exactement à l'ordre réel (Amacuro → Waini →
   Pomeroon → Essequibo → Berbice → Corentyne → Suriname → Commewijne →
   Marowijne).
2. **Cluster « Guayana / delta sud de l'Orénoque »** (Bariquicometo,
   Capuri, Caturi Voari, Coyrama, Varacoyari, R. Maryowapaneko, Lac de
   Caslipa) : ces cours entourent les localités Aromaia, Morequito,
   Macurevoari (= Macureguarai) et Tuteritona — toutes des noms tirés du
   récit de Sir Walter Ralegh, *The Discoverie of Guiana* (1596), et de la
   carte de Guiane de Jodocus Hondius (1598) qui en dérive, laquelle a
   ensuite été recopiée/adaptée par des générations de cartographes
   jusqu'à Jaillot. Cette couche cartographique mélange géographie réelle
   et géographie légendaire (quête d'El Dorado / Manoa, Lac Parime, Lac
   Cassipa). Les toponymes de ce cluster ne se laissent donc pas rattacher
   de façon fiable à l'hydrographie moderne : très fort taux de « non
   déterminé » assumé, conformément à la consigne de ne jamais forcer un
   rapprochement.
3. **Europa River / Ovarabiche R.** : cours distincts, plus à l'ouest, sur
   la côte du Golfe de Paria / péninsule de Paria (entre Cumaná/Verina et
   San José de Macuro) — sans lien hydrographique avec le delta de
   l'Orénoque dans les données. Pas de candidat fiable identifié.

## Tableau récapitulatif

| ID | watercourseId | Toponyme Jaillot | Identification proposée | Confiance |
|---|---|---|---|---|
| N006 | bariquicometo-r | Bariquicometo R. | Non déterminé (bras du delta sud de l'Orénoque, près de Porto Morequito) | ⚠️ faible |
| N010 | capuri-river | Capuri River | Non déterminé (bras/affluent du delta sud, lié à Bariquicometo) | ⚠️ faible |
| N011 | caturi-voari-river | Caturi Voari River | Non déterminé (bras du delta sud, près d'Ariacoa/Macurevoari) | ⚠️ faible |
| N019 | coyrama-r | Coyrama R. | Non déterminé (petit affluent au nord d'Aromaia) | ⚠️ faible |
| N021 | europa-river | Europa River | Non déterminé (cours côtier, péninsule de Paria) | ⚠️ faible |
| N023 | lac-de-caslipa | Lac de Caslipa | **Lac Cassipa** — lac légendaire de la cartographie de Guiane post-Ralegh/Hondius (voisin du mythe du Lac Parime/Manoa-El Dorado) | 🎲 convention cartographique |
| N036 | orenoque | Orénoque | **Fleuve Orénoque** | ✅ fort |
| N038 | ovarabiche-r | Ovarabiche R. | Non déterminé (cours côtier, péninsule de Paria/Golfe de Paria) | ⚠️ faible |
| N042 | r-amacuro | R. Amacuro | **Río/Rivière Amacuro** (frontière Venezuela–Guyana) | ✅ fort |
| N045 | r-berbice | R. Berbice | **Rivière Berbice** (Guyana) | ✅ fort |
| N048 | r-copanama | R. Copanama | Non déterminé (complexe deltaïque à l'est de Paramaribo — Commewijne/Cottica ?) | ⚠️ faible |
...
| N063 | r-marateka | R. Marateka | Non déterminé (complexe deltaïque à l'est de Paramaribo — Commewijne/Cottica ?) | ⚠️ faible |
...
| N065 | r-maryowapaneko | R. Maryowapaneko | Non déterminé (bras du delta de l'Orénoque, embouchure ouest) | ⚠️ faible |
...
| N102 | varacoyari-river | Varacoyari River | Non déterminé (bras du delta sud, près de Macurevoari) | ⚠️ faible |
...
- **Confiance :** ⚠️ faible
- **Raisonnement :** Le cours se jette dans l'Orénoque tout près de Porto
  Morequito, donc géographiquement un bras du delta sud/rive gauche. La
  proximité (en pixels) avec El Tocuyo et Barquisimeto — deux villes
  réelles de l'ouest du Venezuela, à des centaines de km de l'embouchure
  de l'Orénoque — est un artefact de la déformation de la carte de
  Jaillot, pas un indice géographique valide (cf. avertissement CRS). La
  ressemblance phonétique frappante entre « Bariquicometo » et
  « Barquisimeto » est probablement une coïncidence ou une contamination
  de source cartographique, pas une preuve d'identité. Aucun bras moderne
  documenté du delta ne porte de nom apparenté.
- **Sources :** Analyse interne (inventaire + villes-data.js) ; aucune
  source externe concluante trouvée.
...
- **Identification proposée / nom moderne :** Non déterminé.
- **Confiance :** ⚠️ faible
- **Raisonnement :** Cours secondaire directement lié à Bariquicometo R.
  (fork) et débouchant dans l'Orénoque au niveau du même secteur delta
  sud, à proximité de Santo Tomé de Guayana/Tuteritona. Fait partie du
  cluster de toponymes issus de la tradition cartographique post-Ralegh/
  Hondius (voir constat général) ; aucune correspondance fiable avec un
  cours actuel n'a pu être établie.
- **Sources :** Analyse interne. Recherche du toponyme « Capuri » dans le
  texte de Ralegh (*The Discoverie of Guiana*, 1596) infructueuse.
...
- **Identification proposée / nom moderne :** Non déterminé.
- **Confiance :** ⚠️ faible
- **Raisonnement :** Le second élément du nom, « Voari », fait écho à
  « Macurevoari » (le nom du site voisin, dérivé de « Macureguarai » chez
  Ralegh) — signe supplémentaire que ce toponyme appartient à la couche
  cartographique légendaire du delta sud plutôt qu'à un relevé
  hydrographique indépendant. Pas de candidat moderne identifiable avec
...
- **Sources :** Analyse interne ; comparaison avec *The Discoverie of
  ...
  (archive.org, *discoveryofguian00rale*).
...
- **Identification proposée / nom moderne :** Non déterminé.
- **Confiance :** ⚠️ faible
- **Raisonnement :** Position distincte du cluster du delta sud
  (Bariquicometo/Capuri/etc.) : ce cours débouche en mer sur la côte
  entre Cumaná/Verina et San José de Macuro, donc plutôt sur le littoral
  du golfe de Paria/péninsule de Paria que dans le delta lui-même. Cette
  zone est drainée aujourd'hui par de petits cours côtiers (région
  d'Irapa/Güiria) sans grand fleuve identifiable ; aucun candidat clair
  ne s'impose. Le nom « Europa » n'a pas d'équivalent évident dans les
  toponymies indigènes ou coloniales de la région.
- **Sources :** Analyse interne.
...
- **Identification proposée / nom moderne :** Non déterminé.
- **Confiance :** ⚠️ faible
- **Raisonnement :** Comme Europa River, ce cours est positionné sur la
  côte du golfe de Paria entre Cumaná et San José de Macuro — donc sur la
  péninsule de Paria ou son piémont, à l'écart du delta de l'Orénoque.
  Cette portion de côte est aujourd'hui drainée par des cours modestes
  sans grand fleuve repérable (bassin du Golfe de Paria, région
  Sucre/Monagas). Aucun candidat identifiable avec certitude.
- **Sources :** Analyse interne.
...
- **Identification proposée / nom moderne :** **Río/Rivière Amacuro**,
  actuel cours frontalier Venezuela–Guyana, à l'est immédiat du delta de
  l'Orénoque (état vénézuélien de Delta Amacuro).
- **Confiance :** ✅ fort
- **Raisonnement :** Correspondance quasi directe du nom (aucune
  déformation), et position cohérente : juste à l'est de l'Orénoque, à la
  charnière entre les deux territoires (nouvelle-andalousie/suriname dans
  le jeu), exactement comme la rivière Amacuro moderne sépare
  aujourd'hui le Delta Amacuro vénézuélien du Guyana. Les sources
  confirment une présence hollandaise dès 1637 dans le secteur
  Amacuro-Essequibo-Berbice, cohérente avec la période de la campagne
  (1713-1720).
- **Sources :** [Amacuro River - Wikipedia](https://en.wikipedia.org/wiki/Amacuro_River) ;
  [Delta Amacuro - Wikipedia](https://en.wikipedia.org/wiki/Delta_Amacuro) ;
  [Guyana–Venezuela territorial dispute - Wikipedia](https://en.wikipedia.org/wiki/Guyana%E2%80%93Venezuela_territorial_dispute).
...
- **Identification proposée / nom moderne :** Non déterminé.
- **Confiance :** ⚠️ faible
- **Raisonnement :** Appartient clairement au même cluster toponymique
  que Bariquicometo/Capuri/Caturi Voari/Coyrama/Lac de Caslipa/
  R. Maryowapaneko, autour de Macurevoari et Aromaia — couche
  cartographique héritée de Ralegh/Hondius. Le suffixe « -coyari » fait
  écho à « Coyrama » (N019) sans que cela permette d'en tirer une
  identification fiable. Aucun candidat moderne retenu.
- **Sources :** Analyse interne.

## Bilan chiffré

- **7 identifications fortes (✅)** : N036 Orénoque, N042 R. Amacuro,
  N045 R. Berbice, N050 R. Corretine, N056 R. Essequebe, N068
  R. Poumaron, N075 R. Waymy, N098 Suriname — *(8 items au total, cf.
  note ci-dessous)*.
- **1 identification à confiance moyenne (⚠️ moyen)** : N064
  R. Marrawini (Commewijne, hypothèse).
- **10 à confiance faible (⚠️ faible)** : N006 Bariquicometo, N010
  Capuri, N011 Caturi Voari, N019 Coyrama, N021 Europa River, N038
  Ovarabiche, N048 Copanama, N063 Marateka, N065 Maryowapaneko, N102
  Varacoyari.
- **1 convention cartographique (🎲)** : N023 Lac de Caslipa (Lac
  Cassipa légendaire).

*(Note : le tableau ci-dessus liste bien 8 fleuves en confiance forte —
Orénoque, Amacuro, Berbice, Corretine, Essequebe, Poumaron, Waymy,
Suriname — soit 8+1+10+1 = 20, conforme à la liste des 20 cours
traités.)*
