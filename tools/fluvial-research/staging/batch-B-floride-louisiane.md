> ⚠️ **BROUILLON INTERMÉDIAIRE OBSOLÈTE.** Ce fichier a été fusionné et
> corrigé dans `fluvial-identification-complete.md` (voir son bandeau de
> révision). Ne pas utiliser ce document comme référence — l'entrée N089
> (Rivière Sablomuere, faussement attribuée à R006 dans ce brouillon) est
> dépassée. Conservé uniquement à titre d'archive de travail.

# Batch B — Floride / Louisiane (golfe du Mexique nord/est)

16 cours d'eau nommés sur la carte Jaillot (1708), secteur Floride/Louisiane.
Méthode reprise à l'identique de la session précédente (29 cours sans nom) :
toponyme + territoire + établissements proches (`nearbySettlements`) + cours
voisins + recoupement avec Delisle 1718 / Moll / sources historiques
indépendantes. Rappel impératif : les `distanceNm` de l'inventaire sont des
distances **internes à la carte du jeu** (CRS Leaflet Simple sur image
8500×5320 px), jamais des distances terrestres réelles — utilisées ici
uniquement pour la position relative entre points de la même carte.

La Floride du début XVIIIe était très mal relevée : taux élevé de « non
déterminé » attendu et assumé pour ce secteur, comme annoncé dans la
consigne de travail.
...
|---|---|---|---|---|
| N002 | arba-de-canaveral | Arba de Canaveral | Probable « Barra de Cañaveral » — inlet/passe sableuse au droit du Cap Canaveral (pas un vrai fleuve) | ⚠️ faible |
...
| N028 | marpequeue | Marpequeue | Non déterminé (piste faible : baie type « Mar Pequeño », St. Andrew Bay ?) | Non déterminé |
...
| N034 | nieves-r | Nieves R. | Non déterminé (toponyme sanctoral espagnol transposé, pas de piste fiable) | Non déterminé |
| N035 | ochio-ou-belle-riviere | Ochio ou Belle Rivière | **Ohio River** (« la Belle Rivière » = nom français historique de l'Ohio) | ✅ fort |
| N037 | ostras | Ostras | Non déterminé (piste faible : baie ostréicole, Choctawhatchee/St. Andrew Bay) | ⚠️ faible |
| N041 | perdido | Perdido | **Perdido River** (toponyme inchangé) | ✅ fort |
| N057 | r-flores | R. Flores | Non déterminé | Non déterminé |
| N071 | r-snelo | R. Snelo | Non déterminé | Non déterminé |
| N080 | rio-del-canaveral | Rio del Canaveral | Non déterminé (probablement sans lien avec le Cap Canaveral réel — « cañaveral » = roselière générique) | Non déterminé |
...
| N089 | riviere-sablomuere | Rivière Sablomuere | **Red River** (Rivière Rouge) — repris tel quel de R006 (session précédente) | ✅ fort |

## Bilan par confiance

- ✅ fort : 8 (N008, N020, N030, N032, N035, N041, N088, N089)
- ⚠️ moyen : 1 (N081)
- ⚠️ faible : 2 (N002, N037)
- Non déterminé : 5 (N028, N034, N057, N071, N080)
...
- **Identification proposée / nom moderne :** Non déterminé. Piste faible et non retenue : le nom pourrait dériver de « Mar Pequeño » (« petite mer » en espagnol), un descriptif plausible pour une baie fermée par un cordon littoral (type St. Andrew Bay, Panama City) — mais aucune source indépendante ne permet de trancher.
- **Confiance :** Non déterminé
- **Raisonnement :** Aucune correspondance toponymique fiable trouvée. Le secteur du Big Bend/panhandle floridien est notoirement mal cartographié en 1708 ; ne pas forcer un rapprochement.
- **Sources :** Aucune trouvée. Recherche effectuée sur Herman Moll (1715) et Delisle (1718) sans résultat exploitable pour ce toponyme précis.
...
- **Confiance :** Non déterminé
- **Raisonnement :** « Nieves » (« neiges » en espagnol) est un toponyme sanctoral courant (Nuestra Señora de las Nieves) sans lien descriptif réel avec le climat floridien — probablement un nom transplanté sans signification géographique locale, ce qui interdit toute déduction fiable à partir du nom lui-même. Aucun repère de proximité fiable ne permet de trancher entre les nombreux cours du Big Bend (Suwannee, Waccasassa, Withlacoochee, etc.).
- **Sources :** Aucune trouvée permettant de trancher.
...
- **Identification proposée / nom moderne :** Non déterminé avec certitude. Piste faible : une baie/lagune ostréicole du panhandle est de Pensacola — Choctawhatchee Bay ou St. Andrew Bay (Panama City), toutes deux historiquement réputées pour leurs bancs d'huîtres.
- **Confiance :** ⚠️ faible
- **Raisonnement :** « Ostras » (huîtres, en espagnol) est un toponyme descriptif générique très courant sur toute la côte du golfe — la position relative (juste à l'est de l'Escambia) rend plausible un rapprochement avec les baies à huîtres du panhandle est de Pensacola, mais rien ne permet de trancher entre les candidats.
- **Sources :** Aucune source indépendante confirmant un tracé précis ; hypothèse fondée sur le sens descriptif du toponyme et la position relative.
...
- **Identification proposée / nom moderne :** Non déterminé. À noter : ce toponyme n'est très probablement **pas lié** au Cap Canaveral moderne malgré le nom partagé.
- **Confiance :** Non déterminé (possible 🎲 doublon toponymique)
- **Raisonnement :** « Cañaveral » signifie littéralement « roselière/cannaie » en espagnol — un descriptif de paysage extrêmement courant, appliqué à de multiples sites le long des côtes marécageuses de Floride, pas seulement au site qui a donné son nom au Cap Canaveral moderne. La position de ce cours (côte du golfe, Big Bend) très éloignée de celle d'Arba de Canaveral (côte atlantique, proche de San Agustín) confirme qu'il s'agit de deux toponymes distincts portant un nom similaire par pur hasard descriptif, et non du même site dédoublé par erreur de la carte.
- **Sources :** Sens littéral du terme espagnol « cañaveral » ; comparaison de position interne avec N002 dans l'inventaire.
