...
// Page courante de la modal (null = accueil, 1..n = chapitre)
let modalPage = null;
let modalData = null;
...
function renderModal() {
  ...
  // Chapitres disponibles : clés de l'objet dont la valeur n'est pas null
  ...
  if (modalPage === null) {
    ...
    // Page chapitre
    const texte = c.chapitres[modalPage];
    contenu = `
      <div class="modal-chrono-body modal-chrono-body--chapitre">
        <div class="modal-chrono-texte">${texte}</div>
      </div>`;
  }
